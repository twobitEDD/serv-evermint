...
var (
	...
	regexEpoch           = `[1-9][0-9]*`
	nevermindChainID      = regexp.MustCompile(fmt.Sprintf(`^(%s)%s(%s)%s(%s)$`,
		regexChainID,
...
func IsValidChainID(chainID string) bool {
	...
	return nevermindChainID.MatchString(chainID)
}
...
func ParseChainID(chainID string) (*big.Int, error) {
	...
	matches := nevermindChainID.FindStringSubmatch(chainID)
