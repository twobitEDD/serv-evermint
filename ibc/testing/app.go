...
import (
	...
	evermintapp "github.com/EscanBE/evermint/v12/app"
	"github.com/EscanBE/evermint/v12/types"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = evermintapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: evermintapp.DefaultConsensusParams,
