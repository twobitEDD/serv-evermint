...
// EthereumAPI allows applications to connect to an Servermint node that is
// part of the Servermint blockchain. Developers can interact with on-chain EVM data
