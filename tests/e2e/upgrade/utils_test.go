...
// TestVersionsLess tests the NevermindVersion type's Less method with
// different version strings
func TestVersionsLess(t *testing.T) {
	var version NevermindVersion
...
// TestVersionsSwap tests the NevermindVersion type's Swap method
...
// TestVersionsLen tests the NevermindVersion type's Len method
func TestVersionsLen(t *testing.T) {
	var version NevermindVersion = []string{"v9.1.0", "v10.0.0"}
