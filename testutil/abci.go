...
//  3. EndBlock
//  4. Commit
func Commit(ctx sdk.Context, app *app.Nevermind, t time.Duration, vs *tmtypes.ValidatorSet) (sdk.Context, error) {
...
func BroadcastTxBytes(app *app.Nevermind, txEncoder sdk.TxEncoder, tx sdk.Tx) (abci.ResponseDeliverTx, error) {
...
func checkTxBytes(app *app.Nevermind, txEncoder sdk.TxEncoder, tx sdk.Tx) (abci.ResponseCheckTx, error) {
	bz, err := txEncoder(tx)
	if err != nil {
		return abci.ResponseCheckTx{}, err
	}
